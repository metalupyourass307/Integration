...
df = pd.read_csv('/Users/laiyuxuan/Desktop/Integration/C6H6/mapped_coordinates_3D.csv')
x_arr = df['x'].values
y_arr = df['y'].values
z_arr = df['z'].values
...
def rho_promol(x,y,z):
    return (
        density_C(x,y-2.6340,z) +
        density_C(x-2.2869,y-1.3203,z) +
        density_C(x-2.2869,y+1.3203,z) +
        density_C(x,y+2.6340,z) +
        density_C(x+2.2869,y+1.3203,z) +
        density_C(x+2.2869,y-1.3203,z) +
        density_H(x,y-4.6869,z) +
        density_H(x-4.0596,y-2.3432,z) +
        density_H(x-4.0596,y+2.3432,z) +
        density_H(x,y+4.6869,z) +
        density_H(x+4.0596,y+2.3432,z) +
        density_H(x+4.0596,y-2.3432,z) 
